  ...
  init: function () {
    $('#m_tree_1').jstree({
      ...
      core: {
        ...
        data: [{
          ...
          children: [{ text: 'Initially selected', state: { selected: !0 } }, {
            ...
            state: { opened: !0 },
            children: [{ text: 'Another node', icon: 'fa fa-file m--font-waring' }]
            ...
            children: [{ text: 'Item 1', icon: 'fa fa-file m--font-waring' }, {
              text: 'Item 2',
      ...
      core: {
        ...
        check_callback: !0,
        data: {
          url: function (e) {return 'https://keenthemes.com/metronic/themes/themes/metronic/dist/preview/inc/api/jstree/ajax_data.php'},
          data: function (e) {return { parent: e.id }}
        }
      },
      types: { default: { icon: 'fa fa-folder m--font-brand' }, file: { icon: 'fa fa-file  m--font-brand' } },
      state: { key: 'demo3' },
...
jQuery(document).ready(function () {Treeview.init()})