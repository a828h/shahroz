      ...
      columns: [{
        ...
        field: 'TotalPayment', title: 'Payment', type: 'number', sortCallback: function (t, e, a) {
          ...
          return $(t).sort(function (t, a) {
            var i = t[l], n = a[l]
            return isNaN(parseFloat(i)) && null != i && (i = Number(i.replace(/[^0-9\.-]+/g, ''))), isNaN(parseFloat(n)) && null != i && (n = Number(n.replace(/[^0-9\.-]+/g, ''))), i = parseFloat(i), n = parseFloat(n), 'asc' === e ? i > n ? 1 : i < n ? -1 : 0 : i < n ? 1 : i > n ? -1 : 0
          })
        }
...
jQuery(document).ready(function () {DatatableLocalSortDemo.init()})