...
<div class="d-flex align-items-center">
    ...
    <a href="{{route('admin.brands.create')}}"
        ...
        <span class="svg-icon svg-icon-success svg-icon-lg">
            ...
            <!--end::Svg Icon--></span> @lang('admin.brands.create')
    </a>
                ...
                <div class="col-md-3">
                    <div class="m-form__group m-form__group--inline">
                        <div class="m-form__label">
                            <label>@lang('admin.brands.categories'):</label>
                        </div>
...
<div class="card card-custom gutter-b">
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        <th class="pl-0" style="min-width: 100px">@lang('admin.brands.name')</th>
                        <th style="min-width: 120px">@lang('admin.brands.category_id')</th>
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="{{route('admin.brands.edit', $brand)}}"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$brand->name}}</a>
                        </td>
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$brand->category->name}}</span>
                        </td>
                        <td class="pr-0 text-right">
                            ...
                            <a href="javascript:;" data-id="{{$brand->id}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm delete-brand">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                            ...
                            <form id="delete-brand-{{$brand->id}}-form"
    ...
    <div class="card-footer">
        {!! $brands->appends($_GET)->links('components.pagination') !!}
    </div>
</div>
@endsection

@section('scripts')
@include('admin.brands.js.index_js')
@endsection