...
<div class="d-flex align-items-center">
    ...
    <a href="{{route('admin.categories.create')}}"
        ...
        <span class="svg-icon svg-icon-success svg-icon-lg">
            ...
            <!--end::Svg Icon--></span> @lang('admin.categories.create')
    </a>
    ...
    <form class="form">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-9" style="display: flex; justify-content: flex-end; align-items: flex-end">
...
<div class="card card-custom gutter-b">
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        <th class="pl-0" style="min-width: 100px">@lang('admin.categories.name')</th>
                        <th style="min-width: 120px">@lang('admin.categories.slug')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pr-0 text-right">
                            <a href="{{route('admin.categories.edit', $category)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                            ...
                            <a href="javascript:;" data-id="{{$category->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm delete-category">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
    ...
    <div class="card-footer">
        {!! $categories->appends($_GET)->links('components.pagination') !!}
    </div>
</div>
...
@section('scripts')
@include('admin.categories.js.index_js')
@endsection