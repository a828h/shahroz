...
<div class="d-flex align-items-center">
    ...
    <a href="{{route('admin.campaigns.create')}}"
        ...
        <span class="svg-icon svg-icon-success svg-icon-lg">
            ...
            <!--end::Svg Icon--></span>@lang('admin.campaigns.create')
    </a>
                ...
                <div class="col-md-3">
                    <div class="m-form__group m-form__group--inline">
                        <div class="m-form__label">
                            <label>@lang('admin.campaigns.status'):</label>
                        </div>
                        <div class="m-form__control">
                            {!! Form::select(
                            'status',
                            ['' => __('admin.campaigns.statuses.all'),
                            'draft' => __('admin.campaigns.statuses.draft'),
                            'active' => __('admin.campaigns.statuses.active'),
                            'archive' => __('admin.campaigns.statuses.archive')],
                            null,
                ...
                <div class="col-md-3">
                    <div class="m-form__group m-form__group--inline">
                        ...
                        <div class="m-form__control">
                            ...
                            $brands,
                            null,
                            ['class' => "form-control m-bootstrap-select", 'id' => "search_brand", 'multiple' =>
                            true,
                            'data-live-search'=>"true", "data-actions-box"=>"true"]
                            ) !!}
                        </div>
...
@section('scripts')
@include('admin.campaigns.js.index_js')
@endsection
